...
final class HealthKitManager: Sendable {
    ...
    func addStepData(for date: Date, value: Double) async throws {
        ...
        case .notDetermined :
            throw SWError.authNotDetermined
        case .sharingDenied:
            throw SWError.sharingDenied(for: "step count")
    ...
    func addWeightData(for date: Date, value: Double) async throws {
        ...
        case .notDetermined :
            throw SWError.authNotDetermined
        case .sharingDenied:
            throw SWError.sharingDenied(for: "Weight data")
        case .sharingAuthorized:
            break
        @unknown default:
            break
    ...
    /// Create dateInterval between two dates
    /// - Parameters:
    ///   - date: End of date interval. Ex: today
    ///   - daysBack: Start of date interval. Ex: 28 days ago
    /// - Returns: Date range between wo dates as a DateInterval
